...
```
The source code is available at [GitHub](https://github.com/SriAbhay/Data-product). [Just click here!](https://github.com/SriAbhay/Data-product)
...
map %>%
   addTiles() %>%
   addMarkers(lat=26.9260233, lng=81.2059523, popup = benrathPalacePopup)
```
